...
// let increment = 1
// while (increment <= 10) {
//   console.log(`Esta é a ${increment}ª vez que esta frase é exibida no console.`)
...
const li = names.reduce((acc, name) => acc += `<li>${name}</li>`, '')
// console.log(li)
...
for(i = 0; i < numbers.length; i++) {
  sumNumbers = sumNumbers + parseInt(numbers[i])
}
