...
let totalRandomWord = randomWord.length
// console.log(randomWord[totalRandomWord - 1])
/*
...
// console.log(sm = summerMessage.toLowerCase())
...
// console.log(wm = winterMessage.toUpperCase())
...
*/
let indexV = winterMessage.indexOf('v')
// console.log('index de v é: ' + indexV)
...
*/
let indexN = winterMessage.indexOf('n', -1)
let indices = []

while (indexN != -1) {
	indices.push(indexN)
	indexN = winterMessage.indexOf('n', indexN + 1)
}
let lastIndice = indices.length
// console.log(indices[lastIndice - 1])
// console.log('index do último n é: ' + indices[lastIndice - 1])
...
const positionJK = harryPotterAuthor.search('J.K.')
// console.log(harryPotterAuthor.split(" ")[positionJK])

// const hpa = harryPotterAuthor.split(" ")[0]
// console.log(hpa)
/*
...
const splitText = bestMovie.split(':')
let frase = splitText[splitText.length - 2]
const realBestMovie = `${frase}: "Moonlight"`
...
let nome = nameArr[0].charAt(0).toUpperCase() + nameArr[0].slice(1)
let sobrenome = nameArr[1].charAt(0).toUpperCase() + nameArr[1].slice(1)
let newName = nome +' '+sobrenome
// console.log(newName)
