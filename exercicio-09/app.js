...
console.log(convertToString(12340))
console.log(convertToString('asdfa ffa'))
...
/*
  ...
  - Crie uma função que retorne a quantidade de caracteres que uma string  
    ...
    */
    ...
    const totalLenghtString = valor => String(valor.length)
    console.log(totalLenghtString('arroz com bife e salada'))
...
/*
  ...
  */
  ...
  const fraseToLower = frase => frase.toLowerCase()
  console.log(fraseToLower(frase))
/*
  04
  ...
  */
  const returnIndex = (caractere, str) => `Encontrei na posição ${str.indexOf(caractere)}`
  console.log(returnIndex('v', 'jeova'))
/*
  05
  ...
  - Crie uma função que, ao ser invocada, retorna um boolean indicando se o item  
    ...
    */
    const isArgumentBoolean = (arg, arr) => arr.includes(arg)
    console.log(isArgumentBoolean('bullets', ['guns', 'fire', 'shot', 'bullets']))
/*
  06
  ...
  - Crie uma função que retorna a concatenação de 2 arrays, passados como  
    ...
    */
    const mergeTwoArray = (...arr) => [...arr[0], ...arr[1]]
    console.log(mergeTwoArray(['asdf', 'fwerewr', 332, 'dddd'], [53, 'oooq', 'NAsks']))
/*
  07
  ...
  - Crie uma função que retorna o array passado como argumento em sua invocação,  
    ...
    */
    ...
    console.log(removeLastItem(['Honduras', 'Portugal', 'Mauritania', 'Turkmenistan', 'San Marino']))
/*
  08
  ...
  - Crie uma função que retorna se o valor passado como argumento em sua  
    invocação é null.
    */
    const isValueNull = arg => arg ? arg : `É null`
// console.log(isValueNull('adf'))
...
/*
  ...
  - Invoque a função que recebe um callback por parâmetro, passando como  
    ...
    foi exibido.
    */
    const funCallBack = func => func()
    const funcNome = () => console.log('Aimee Parga')
    funCallBack(funcNome)
/*
  10
  ...
  - Faça com que a invocação da função descrita no 1º item deste exercício (10)  
    ...
    */
    const func1 = (func, n) => func(n) 
    const tripleNum = num => console.log(num * 3)
...
/*
  ...
  */
  ...
  numbers.forEach((value, index) => {
    let msgNum = `O ${index + 1}º item do array [${numbers}] é ${value}.`
    console.log(msgNum)
  })
  ...
  - Após a conversão, verifique se a cópia do array lettersCopy realmente foi  
    ...
    */
    ...
    letters.forEach((value, index, array) => {
      if (letters[index] === lettersCopy[index]) {
        console.log("Sim, são iguais!")
      } else {
        console.log("Não são iguais os arrays")
      }
    })
...
/*
  ...
  - Se o array conter apenas um nome, como "Rafael", por exemplo, a mensagem  
    retornada deve ser "Rafael curtiu issoisso";  
  ...
  - Se o array conter 4 ou mais nomes, a mensagem retornada deve ser  
    ...
    */
    const typePost = ['post', 'video', 'foto']
    const peoples = ['Cassey', 'Armand', 'Norberto', 'Darrin', 'Sung', 'Dorine']
    let type;

    const randomPostPeopleLiked = peoples.map(p => {
      type = typePost[Math.floor(Math.random()*typePost.length)]
      return {name: p, type: type}
    })

const LIKED_NOBODY = 'Ninguém curtiu isso'
const LIKED_ONLY = people => `${people[0].type}: ${people[0].name} curtiu isso`
const LIKED_SOME = people => `${people[0].type}: ${people[0].name} e ${people[1].name} curtiram isso`
const LIKED_TRHEE_PEOPLE = people => `${people[0].type}: ${people[0].name}, ${people[1].name} e ${people[2].name} curtiram isso`
const LIKED_MANY = (people, quantity) => `${people[0].type}: ${people[0].name}, ${people[1].name} e mais ${quantity-2} pessoas curtiram isso`

const filterLikeByType = (names, typePost) => names.filter((n) => n.type === typePost)

let liked = []
const likedByType = () => {
  for (typeMidia of typePost) {
    liked.push(filterLikeByType(randomPostPeopleLiked, typeMidia))
  }
  return liked
}
...
const likes = (peoples) => {
  return peoples.map(people => {
    switch (people.length) {
      case 0: return LIKED_NOBODY //TODO verificar qual item typePost não foi incluido
      case 1: return LIKED_ONLY(people)
      case 2: return LIKED_SOME(people)
      case 3: return LIKED_TRHEE_PEOPLE(people)
      default: return LIKED_MANY(people, people.length)
    }
  })
}

console.log(likes(likedByType()))